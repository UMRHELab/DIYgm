...
This code is built to run on a Raspberry Pi Zero W with Bluetooth enabled using the UMRHE DIYgm Board and Raspbian.
...
We are working on a written [Wiki](https://github.com/UMRHELab/DIYgm/wiki) and will hopefully have that soon; however, the video tutorials will always be our first recommendation.
...
Raspberry Pi software for Bluetooth connection to Mobile Applications
